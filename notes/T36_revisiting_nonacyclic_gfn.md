...
## 与谁对话
- **T01**：本文扩展了原始GFlowNet论文的工作，探讨了在包含循环的状态空间中应用GFlowNets的可能性，而原始论文主要关注于无环图环境。
- **T19**：本文是对T19工作的进一步发展，提供了更简单的理论框架和新的方法论见解，以解决非无环GFlowNets的问题。
- **T07**：本文讨论了固定反向策略下的损失稳定性，这与T07中关于GFN训练过程中loss与分布误差之间关系的研究相呼应，提供了更深入的理解。
