...
## 与谁对话
1. T01: GFlowNet原始论文(NeurIPS2021) - 提出GFlowNet的基本框架。
2. T03: Trajectory Balance - 提出轨迹平衡算法。
3. T05: SubTB - 提出子轨迹平衡算法。
4. T17: 散度训练 - 探讨不同散度训练方法的效果。
5. T19: 非无环理论 - 探讨非无环图上的GFlowNet应用。
6. O08: GFN隐式学OT计划 - 探讨GFlowNet在最优传输中的应用。
