...
## 与谁对话
- **T09**: 本文从变分视角出发，统一解释了轨迹平衡（TB），而我们的工作进一步展示了GFlowNet在最优传输问题中的隐式学习能力，两者都强调了GFlowNet在概率分布学习上的潜力。
- **T19**: 我们的工作基于非无环GFlowNet理论，探讨了其在最优传输问题中的应用，进一步拓展了T19中提出的理论框架。
- **O07**: 本文展示了如何使用GFlowNet学习最短路径，而我们的研究则揭示了GFlowNet在学习最优传输计划方面的隐式能力，两者都在探索GFlowNet在图上的应用潜力。
